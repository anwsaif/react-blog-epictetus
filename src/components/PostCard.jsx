...
const PostCard = ({ data, id }) => {
  ...
  return (
    <Link to={`/post/` + data.id} className={`post-card flex w-full grow flex-col transition duration-300 ease-in-out hover:scale-[.98] hover:opacity-80 gap-x-8 gap-y-5 sm:w-2/5 lg:w-3/12 ` + (isIndexAndFirst ? "lg:w-max lg:flex-row lg:items-center" : "") }>
